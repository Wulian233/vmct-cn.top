...
<DownloadLinks :methods="[
  { id: 'lanzou', text: '下载汉化（未完成）', icon: '/imgs/svg/lanzou.svg', link: '/doing/' },
  { id: 'bilibili', text: '汉化宣传片（未完成）', icon: '/imgs/svg/bilibili.svg', link: '/doing/' },
...
:-|:-|:-|:-
[链接](https://www.curseforge.com/minecraft/modpacks/skyfactory-5)|Forge|mc1.20.1 5.0.2|*维护中*|
